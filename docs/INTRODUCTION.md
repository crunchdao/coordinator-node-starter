...
2. **Running Locally** – run everything with Docker and `make` commands.
3. **Core Concepts** – interfaces, base class, tick vs predict, timeouts.
4. **Predict Worker** – the main loop that talks to all models.
5. **Score Worker** – how scoring is done and why it is isolated.
6. **Report Worker** – how to expose leaderboards and metrics.
7. **Entities** – data structures for models, predictions, and scores.
8. **Build Your Own Challenge** – create your own public game.
9. **Deployment** – from local to production.
10. **FAQ** – common problems and how to fix them.
