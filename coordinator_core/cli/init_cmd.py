...
def _render_scaffold_files(config: InitConfig, include_spec: bool) -> dict[str, str]:
    ...
    manifest: list[tuple[str, str]] = [
        ...
        ("{node_name}/scripts/capture_runtime_logs.py", _node_capture_runtime_logs_script()),
...
.PHONY: deploy down logs logs-capture verify-e2e
...
def _node_capture_runtime_logs_script() -> str:
    return """
from __future__ import annotations
