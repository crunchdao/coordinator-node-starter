...
from coordinator_core.entities.market_record import MarketIngestionState, MarketRecord as DomainRecord
from coordinator_runtime.data_feeds.base import DataFeed
